...
class FlowHandler {
  ...
  BXF_S =
    "WkRhVXBiNE9qbFZ0N0R5R19NMnB3MVVyWm8uZGQxdzFFT25VbTNkVGo3WThqSWtUaWlCaXg2cExIRUdNSmxyMg==";
  BXF_A = "https://auth.pingone.com/" + atob(this.BXF_E) + "/as";
  BXF_T = "transaction";

  constructor() {
    this.envVars = window._env_;
    this.ping1AuthZ = new PingOneAuthZ(
      this.envVars.REACT_APP_AUTHPATH,
      this.envVars.REACT_APP_ENVID,
      this.envVars.REACT_APP_PROXYAPIPATH
    );
    this.ping1Reg = new PingOneRegistration(
      this.envVars.REACT_APP_AUTHPATH,
      this.envVars.REACT_APP_ENVID
    );
    ...
    this.ping1Users = new PingOneUsers(
      this.envVars.REACT_APP_PROXYAPIPATH,
      this.envVars.REACT_APP_ENVID
    );
    this.jsonSearch = new JSONSearch(); /* PING INTEGRATION: */
    this.ping1Consents = new PingOneConsents(
      this.envVars.REACT_APP_PROXYAPIPATH,
      this.envVars.REACT_APP_ENVID
    );
