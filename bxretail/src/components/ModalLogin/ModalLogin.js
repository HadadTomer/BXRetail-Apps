              ...
              <TabContent activeTab={this.state.activeTab}>
                <TabPane tabId="1">
                  ...
                  <FormGroup className="form-group-light">
                    ...
                    <div>
                      <Button type="button" color="link" size="sm" className="pl-0" onClick={() => { this.toggleTab('4'); }}>{data.form.buttons.reset}</Button>
                    </div>
                  </FormGroup>
                  <FormGroup className="form-group-light">
                ...
                <TabPane tabId="2">
                  ...
                  <div className="text-center">
                    <Button type="button" color="link" size="sm" onClick={this.toggle.bind(this)}>{data.form.buttons.help}</Button>
                  </div>
                </TabPane>
                <TabPane tabId="3">
                ...
                <TabPane tabId="4">
                  ...
                  <div className="mb-3">
                    <Button type="button" color="primary" onClick={() => { this.toggleTab('5'); }}>{data.form.buttons.submit}</Button>
                  </div>
                </TabPane>
                <TabPane tabId="5">
